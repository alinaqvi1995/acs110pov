...
(function() {
    ...
    function windowLoadContent() {
        setTimeout(() => {
            if (document.querySelector("#topnav-hamburger-icon")) {
                document.querySelectorAll("#topnav-hamburger-icon").forEach(function(e) {
                    e.addEventListener("click", toggleHamburgerMenu)
                });
            }
        }, 0);
        ...
        if (sidebarMenu) {
            ...
            if (offset > 300) {
                ...
                if (verticalMenu && verticalMenu.querySelector(".simplebar-content-wrapper")) {
                    if (offset === 330) {
                        verticalMenu.querySelector(".simplebar-content-wrapper").scrollTop = offset + 150;
                    } else {
...
var menuItems = document.querySelectorAll("#menu-tabs li a");
